...
<body>
    ...
    <div class="container for-you-banner">
        <div class="row">
            <div class="col">
                <h1 class="for-you-head">FOR YOU</h1>
                <p>
                    FIND YOUR SCENT. We believe that everyone deserves to use safe
                    and effective personal care products without having to sacrifice
                    their sustainability values. That's why we offer a wide range of
                    products to choose from, so you can find the perfect ones for your
                    individual needs.
                </p>
            </div>
            <div class="col">
                <img class="for-you-image" src="assets/images/Index/ForYou_shop.png" alt="">
            </div>
        </div>
    </div>
        ...
        <div class="row container mx-auto pt-3">
            ...
            <div class="footer-one col-lg-4 col-md-8 col-sm-16">
                ...
                <ul class="text-uppercase">
                    ...
                    <li><a href="informaton.php">Refill Initiative</a></li>
                </ul>
            </div>
        </div>
