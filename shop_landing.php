...
<body>
    ...
    <!--Landing Content-->
    <div id="Banner">
        <img class="header-image" src="assets/images/Landing/Landing_banner.jpg" alt="">
    </div>

    <div class="landing-row-1">
        <div class="landing-intro">
            <h1>Shop Our Products</h1>
            <p>
                At Sustainer, we believe that everyone deserves to live in a healthy and
                sustainable environment. That's why we offer a wide range of sustainable personal
                care products and household items that are good for you and good for the planet.
                Our products are made with natural, organic, and biodegradable ingredients, and they
                are packaged in recyclable or compostable materials. We also source our ingredients from
                sustainable suppliers. <br> <br>

                When you shop at Sustainer, you can be confident that you are making choices that are good
                for you, your family, and the planet.
            </p>
        </div>
        <div>
            <img class="intro-image" src="assets/images/Landing/Landing_intro.png" alt="">
        </div>
    </div>

    <div class="landing-row-2">
        <div class="for-you-container">
            <a href="for_you.php"><img class="for-you" src="assets/images/Landing/ForYou_landing.png"></a>
            <div>
                <a href="for_you.php">
                    <h2>For You</h2>
                </a>
        ...
        <div class="household-container">
            <a href="household.php"><img class="household" src="assets/images/Landing/household_landing.png" href="household.php"></a>
            <div>
                <a href="household.php">
                    <h2>Household</h2>
                </a>
                <p>Cleaner and More Sustainable</p>
            </div>
        </div>
    </div>
