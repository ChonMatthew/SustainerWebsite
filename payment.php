...
<body>
   ...
   <section class="my-5 py-5">
    ...
    <div class="mx-auto container text-center">
        ...
        <form class="text-center" method="POST" action="payment_validation.php">
        <input class="btn btn-primary" type="submit" value="Pay Now" name="pay_btn"></input>
        </form>

        
        <p class="text-center pt-4">Please Make Your Payment</p>
        <h4 class="text-center">Page will redirect to Home page in 15 seconds.</h4>
    </div>
   </section>
